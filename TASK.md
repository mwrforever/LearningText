...
| --- | --- | --- | --- | --- |
| 04 | 存储与 VFS 详细设计（`docs/superpowers/specs/2026-09-16-存储与VFS-design.md`） | 名称校验与 Unicode 规范化规则（三平台非法字符并集/保留名）、SQLite 错误码 → E_VFS_* 错误映射表、迁移脚本组织形态、事务封装模板、回收站保留策略 | M1 开工前 | 初稿待评审（2026-09-16） |
